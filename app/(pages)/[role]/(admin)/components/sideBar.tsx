...
import { ProfileResponse } from "@/app/lib/(auth)/interface/interface";
...
const Sidebar = ({
  ...
  return (
    <motion.div
      className="bg-white shadow-lg sticky h-full py-5 px-2 flex flex-col items-start border-r border-gray-200"
    ...
    >
      <div
        className={`custom text-3xl px-4 font-medium text-[#023E8A] mb-6 mt-[2px] flex items-center justify-center transition-colors duration-150`}
      >
        <span>H</span>
        {isHovered && (
          <motion.span
        ...
        <div className="w-full">
          <div className="flex flex-col space-y-3 w-full">
            ...
            <Dropdown
              ...
              iconsDrop={[
                <HiOutlineAcademicCap width={32} height={32} key={"student"} />,
                <FaChalkboardTeacher width={32} height={32} key={"teacher"} />,
                <GrUserWorker width={32} height={32} key={"staff"} />,
              ]}
              title="Recap"
          ...
          <div className="w-full flex flex-col space-y-3">
            ...
            />
            <SidebarItem
              icon={<FaChalkboardTeacher width={32} height={32} />}
              text="Teacher"
              isHovered={isHovered}
              url="/"
            />
            <SidebarItem
              icon={<GrUserWorker width={32} height={32} />}
              text="Staf"
              isHovered={isHovered}
              url="/"
            />
            <SidebarItem
              icon={<HiOutlineAcademicCap width={32} height={32} />}
              text="Student"
              isHovered={isHovered}
              url="/"
            />
